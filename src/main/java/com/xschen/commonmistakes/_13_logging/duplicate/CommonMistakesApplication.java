...
public class CommonMistakesApplication {
    ...
    public static void main(String[] args) {
        ...
        /**
         * 1-fix-a。 logger配置继承关系，导致日志重复记录 logger 继承了 root，日志会被记录两次，注释掉appender-ref即可
         */
        //String right1 = "classpath:logging/logger-right-1.xml";
        //System.setProperty("logging.config", right1);

        /**
         * 1-fix-b. additivity="false"，日志不向上传递，只在自己的本 logger 中输出
         */
        ...
        /**
         * 2-fix-a. 对于 LevelFilter, 增加 onMatch  &  onMismatch
         */
        String filterRight = "classpath:logging/filter-right.xml";
        System.setProperty("logging.config", filterRight);
