...
public class TwoTimeoutConfigController {
    ...
    public String redis() {
        ...
        try (JedisPool jedisPool = new JedisPool(config, "119.45.56.227", 6379, 5000);
             Jedis jedis = jedisPool.getResource()) {
            return jedis.set("test1", "test");
        }
    }
    ...
    public String http() {
        ...
        HttpGet httpGet = new HttpGet("http://127.0.0.1:8080/twotimeoutconfig/test");
